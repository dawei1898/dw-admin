package com.dw.admin.components.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        String url = "jdbc:mysql://localhost:3306/dwa";
        String username = "root";
        String password = "";

        // 需要配置的表
        String tableName = "dwa_user";
        ...
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> builder
                        ...
                        .commentDate("yyyy") // 注释日期格式
                        .dateType(DateType.TIME_PACK) // 设置时间类型策略
                        .disableOpenDir() // 禁止生成后自动打开目录
                )
                .packageConfig(builder -> builder
                        .parent("com.dw.admin.components.generator.code") // 设置父包名
